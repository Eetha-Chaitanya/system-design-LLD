...
import domain.dispenser.chainofresponsibility.NoteDispenser100;
import domain.dispenser.chainofresponsibility.NoteDispenser200;
import domain.dispenser.chainofresponsibility.NoteDispenser500;
